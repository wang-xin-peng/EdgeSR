...
在 Set5/Set14/BSD100 上计算 PSNR、SSIM 和 LPIPS。
用法：
    python -m src.test --config configs/edgesr_standard.yaml --model baseline --checkpoint checkpoints/baseline_best.pt
"""
