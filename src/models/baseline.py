...
架构：
    输入 -> Conv3x3 -> [ResBlock x 16] -> Conv3x3 -> PixelShuffle -> Conv3x3 -> 输出

参考：Enhanced Deep Residual Networks for Single Image Super-Resolution (EDSR, CVPR 2017)
简化：移除 BatchNorm，使用固定残差缩放。
"""
